...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { MessagesController } from './router/messages/messages.controller';
...
const models: TsoaRoute.Models = {
  'AWS.SQS.SendMessageResult': {
    dataType: 'refObject',
    properties: {
      MD5OfMessageBody: { dataType: 'string' },
      MD5OfMessageAttributes: { dataType: 'string' },
      MD5OfMessageSystemAttributes: { dataType: 'string' },
      MessageId: { dataType: 'string' },
      SequenceNumber: { dataType: 'string' },
    },
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(MessagesController.prototype.produce),

    function MessagesController_produce(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.produce.apply(
          controller,
