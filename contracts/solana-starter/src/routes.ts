...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { WalletController } from './router/wallet/wallet.controller';
...
const models: TsoaRoute.Models = {
  WalletResponse: {
    ...
    type: {
      ...
      nestedProperties: { publicKey: { dataType: 'string', required: true } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.get(
    ...
    function WalletController_getWallet(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getWallet.apply(
          controller,
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      WalletController.prototype.createWallet
    ),

    function WalletController_createWallet(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.createWallet.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
